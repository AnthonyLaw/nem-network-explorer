...
const CreateStandaloneTransactionFromDTO = (transactionDTO, transactionInfo) => {
    if (transactionDTO.type === TransactionType_1.TransactionType.TRANSFER) {
        ...
        return new MosaicDefinitionTransaction_1.MosaicDefinitionTransaction(extractNetworkType(transactionDTO.version), extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.fee), transactionDTO.nonce, new MosaicId_1.MosaicId(transactionDTO.mosaicId), new MosaicProperties_1.MosaicProperties(new UInt64_1.UInt64(transactionDTO.properties[0].value), (new UInt64_1.UInt64(transactionDTO.properties[1].value)).compact(), new UInt64_1.UInt64(transactionDTO.properties.length === 3 ? transactionDTO.properties[2].value : [0, 0])), transactionDTO.signature, PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, extractNetworkType(transactionDTO.version)), transactionInfo);
    }
        ...
        return new MosaicAliasTransaction_1.MosaicAliasTransaction(extractNetworkType(transactionDTO.version), extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.fee), transactionDTO.actionType, transactionDTO.namespaceId, transactionDTO.mosaicId, transactionDTO.signature, PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, extractNetworkType(transactionDTO.version)), transactionInfo);
    }
    else if (transactionDTO.type === TransactionType_1.TransactionType.ADDRESS_ALIAS) {
        return new AddressAliasTransaction_1.AddressAliasTransaction(extractNetworkType(transactionDTO.version), extractTransactionVersion(transactionDTO.version), Deadline_1.Deadline.createFromDTO(transactionDTO.deadline), new UInt64_1.UInt64(transactionDTO.fee), transactionDTO.actionType, transactionDTO.namespaceId, transactionDTO.address, transactionDTO.signature, PublicAccount_1.PublicAccount.createFromPublicKey(transactionDTO.signer, extractNetworkType(transactionDTO.version)), transactionInfo);
    }
