...
class ModifyMultisigAccountTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, minApprovalDelta, minRemovalDelta, modifications, networkType) {
        return new ModifyMultisigAccountTransaction(networkType, TransactionVersion_1.TransactionVersion.MODIFY_MULTISIG_ACCOUNT, deadline, new UInt64_1.UInt64([0, 0]), minApprovalDelta, minRemovalDelta, modifications);
    }
    /**
     * @internal
