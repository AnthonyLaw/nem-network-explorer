...
class AggregateTransaction extends Transaction_1.Transaction {
    ...
    static createComplete(deadline, innerTransactions, networkType, cosignatures) {
        return new AggregateTransaction(networkType, TransactionType_1.TransactionType.AGGREGATE_COMPLETE, TransactionVersion_1.TransactionVersion.AGGREGATE_COMPLETE, deadline, new UInt64_1.UInt64([0, 0]), innerTransactions, cosignatures);
    }
    /**
    ...
    static createBonded(deadline, innerTransactions, networkType, cosignatures = []) {
        return new AggregateTransaction(networkType, TransactionType_1.TransactionType.AGGREGATE_BONDED, TransactionVersion_1.TransactionVersion.AGGREGATE_BONDED, deadline, new UInt64_1.UInt64([0, 0]), innerTransactions, cosignatures);
    }
    /**
     * @internal
     * @returns {AggregateTransaction}
