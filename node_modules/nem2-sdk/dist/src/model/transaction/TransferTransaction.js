...
class TransferTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, recipient, mosaics, message, networkType) {
        return new TransferTransaction(networkType, TransactionVersion_1.TransactionVersion.TRANSFER, deadline, new UInt64_1.UInt64([0, 0]), recipient, mosaics, message);
    }
    /**
     * @internal
