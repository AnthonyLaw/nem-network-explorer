...
class SecretProofTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, hashType, secret, proof, networkType) {
        return new SecretProofTransaction(networkType, TransactionVersion_1.TransactionVersion.SECRET_PROOF, deadline, UInt64_1.UInt64.fromUint(0), hashType, secret, proof);
    }
    /**
     * @internal
