...
class SecretLockTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, mosaic, duration, hashType, secret, recipient, networkType) {
        return new SecretLockTransaction(networkType, TransactionVersion_1.TransactionVersion.SECRET_LOCK, deadline, UInt64_1.UInt64.fromUint(0), mosaic, duration, hashType, secret, recipient);
    }
    /**
     * @internal
