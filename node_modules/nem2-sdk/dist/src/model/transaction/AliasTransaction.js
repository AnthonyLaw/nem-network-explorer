...
class AliasTransaction extends Transaction_1.Transaction {
     ...
     */
    static createForAddress(deadline, aliasAction, namespaceId, address, networkType) {
        return AddressAliasTransaction_1.AddressAliasTransaction.create(deadline, aliasAction, namespaceId, address, networkType);
    }
    /**
     ...
     */
    static createForMosaic(deadline, aliasAction, namespaceId, mosaicId, networkType) {
        return MosaicAliasTransaction_1.MosaicAliasTransaction.create(deadline, aliasAction, namespaceId, mosaicId, networkType);
    }
}
