...
class RegisterNamespaceTransaction extends Transaction_1.Transaction {
    ...
    parentId, signature, signer, transactionInfo) {
        super(TransactionType_1.TransactionType.REGISTER_NAMESPACE, networkType, version, deadline, fee, signature, signer, transactionInfo);
     ...
     */
    static createRootNamespace(deadline, namespaceName, duration, networkType) {
        return new RegisterNamespaceTransaction(networkType, TransactionVersion_1.TransactionVersion.REGISTER_NAMESPACE, deadline, new UInt64_1.UInt64([0, 0]), NamespaceType_1.NamespaceType.RootNamespace, namespaceName, new NamespaceId_1.NamespaceId(namespaceName), duration);
    }
    /**
     ...
     * @returns {RegisterNamespaceTransaction}
     */
    static createSubNamespace(deadline, namespaceName, parentNamespace, networkType) {
        let parentId;
        ...
        return new RegisterNamespaceTransaction(networkType, TransactionVersion_1.TransactionVersion.REGISTER_NAMESPACE, deadline, new UInt64_1.UInt64([0, 0]), NamespaceType_1.NamespaceType.SubNamespace, namespaceName, new NamespaceId_1.NamespaceId(nem2_library_1.subnamespaceNamespaceId(parentNamespace, namespaceName)), undefined, parentId);
    }
    /**
     * @internal
