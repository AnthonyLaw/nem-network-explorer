...
class LockFundsTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, mosaic, duration, signedTransaction, networkType) {
        return new LockFundsTransaction(networkType, TransactionVersion_1.TransactionVersion.LOCK, deadline, UInt64_1.UInt64.fromUint(0), mosaic, duration, signedTransaction);
    }
    /**
     * @internal
