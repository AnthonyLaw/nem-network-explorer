...
class MosaicSupplyChangeTransaction extends Transaction_1.Transaction {
    ...
    static create(deadline, mosaicId, direction, delta, networkType) {
        return new MosaicSupplyChangeTransaction(networkType, TransactionVersion_1.TransactionVersion.MOSAIC_SUPPLY_CHANGE, deadline, new UInt64_1.UInt64([0, 0]), mosaicId, direction, delta);
    }
    /**
     * @internal
